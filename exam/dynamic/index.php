        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 py-5">
                    ...
                    <p class="mt-3 font-italic" style="font-size: 1.2rem; color:#000;">
                        "<span x-text="life_motto"></span>"
                    </p>

                    <p class="mt-3" style="font-size: 1.1rem; color: #000;">
                        <span x-text="short_description ?? 'Passionate about building efficient, modern software solutions.'"></span>
                    </p>
                </div>
