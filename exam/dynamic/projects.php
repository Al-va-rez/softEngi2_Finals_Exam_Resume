<div class="container my-4" x-data="projectsComponent()" x-init="fetchProjects()">
    ...
    <tbody>
      <template x-for="project in projects" :key="project.id">
        <tr>
          ...
          <td x-text="project.category"></td>
          <td x-text="project.description"></td>
          <td><a :href="project.github_link" target="_blank" x-text="project.github_link"></a></td>
          <td>
            <img :src="'../images/' + project.img_src" class="img-thumbnail" style="max-width:100px;" x-show="project.img_src">
          </td>
          <td>
            <button class="btn btn-info btn-sm mr-2" @click="openModal('edit', project)">Edit</button>
            <button class="btn btn-danger btn-sm" @click="openDeleteModal(project)">Delete</button>
          </td>
        </tr>
      </template>
  ...
  <button class="btn btn-success mb-3" @click="openModal('add')">Add Project</button>
