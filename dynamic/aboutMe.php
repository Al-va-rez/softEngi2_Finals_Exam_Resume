    ...
    <div>
      ...
      <div class="card p-4 mt-3"
        ...
        <p style="font-size: 1rem; color:#000;">
          <span x-text="aboutMe.interests"></span>.<br><br>
          <span x-text="aboutMe.inspiration"></span>.<br><br>
  ...
  <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-hidden="true" x-ref="deleteModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          Are you sure you want to clear content? This will remove <span class="font-weight-bold">all</span> content in this section.
        </div>
        <div class="modal-footer">
